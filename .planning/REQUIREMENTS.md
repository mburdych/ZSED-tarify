...
- [x] **RELI-04**: Stav zastaranosti dat je explicitne dostupny pre uzivatela ako odlisny entity atribut/sensor (vek poslednej uspesnej aktualizacie, nielen timestamp).
